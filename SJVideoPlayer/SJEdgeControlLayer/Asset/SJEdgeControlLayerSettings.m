...
- (void)reset {
    ...
    self.playCenterBtnImage = [SJEdgeControlLayerLoader imageNamed:@"play_icon"];
    self.pauseCenterBtnImage = [SJEdgeControlLayerLoader imageNamed:@"pause_icon"];
    self.progress_thumbImage = [SJEdgeControlLayerLoader imageNamed:@"player_circle"];
    ...
    self.progress_traceColor = [UIColor colorWithRed:43 / 256.0 green:255 / 256.0 blue:218 / 256.0 alpha:1];
